 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
    ...
    let mpt = clockString(_mpt)
      const sections = [
   {
	title: `${htki} 汉 DASHBOARD 」 ${htka}`,
	rows: [
	    {title: `⛔ Info Bot`, rowId: ".botinfo", description: "✧ Info nya Xia ><"},
	    {title: `👤 Owner`, rowId: ".owner", description: "✧ Ini Developer ku ^~^"},
            {title: `🗣  Request Fitur`, rowId: ".request", description: "✧ Request Fitur menarik ke Owner"},
            {title: `📊 Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 SaxiaBotz"},
	]
    },{
	title: `${htki} 汉 INFO BOT 」 ${htka}`,
	rows: [
	    ...
	    {title: `『 Donasi 』`, rowId: ".donasi", description: '✧ Support BOT agar on non stop'},
	{title: `『 My Profile 』`, rowId: ".profile", description: '✧ Siapa ya kamu?...'},
	]
	},{
	title: `${htki} 汉 MENU NYA ${htka}`,
	rows: [
	...
	title: `${htki} 汉 INFO TAMBAHAN 」 ${htka}`,
	rows: [
